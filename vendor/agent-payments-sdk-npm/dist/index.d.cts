...
declare const SHARING_CONFIG_SEED: Buffer;
/**
 ...
 */
declare function getInvoiceIdPDA(tokenMint: PublicKey, currencyMint: PublicKey, amount: number, memo: number, startTime: number, endTime: number): [PublicKey, number];
/**
...
export { type AcceptPaymentParams, type AcceptPaymentSimpleParams, type AgentBalances, BONDING_CURVE_SEED, BUYBACK_AUTHORITY_SEED, type BuildAcceptPaymentParams, type BuybackTriggerParams, type CreateParams, type DistributePaymentsParams, type ExtendAccountParams, GLOBAL_CONFIG_SEED, type GlobalConfig, INVOICE_ID_SEED, OFFLINE_PUMP_PROGRAM, PAYMENT_IN_CURRENCY_SEED, PROGRAM_ID, PUMP_AGENT_PAYMENTS_PROGRAM_ID, PUMP_FEES_PROGRAM_ID, PUMP_PROGRAM_ID, PumpAgent, PumpAgentOffline, type PumpAgentPayments, type PumpEnvironment, SHARING_CONFIG_SEED, TOKEN_AGENT_PAYMENTS_MIN_RENT_EXEMPT_LAMPORTS, TOKEN_AGENT_PAYMENTS_SEED, type TokenAgentPaymentInCurrency, type TokenAgentPayments, type UpdateAuthorityParams, type UpdateBuybackBpsOptions, type UpdateBuybackBpsParams, type VaultBalance, WITHDRAW_AUTHORITY_SEED, type WithdrawParams, decodeGlobalConfig, decodeTokenAgentPaymentInCurrency, decodeTokenAgentPayments, getBondingCurvePDA, getBuybackAuthorityPDA, getGlobalConfigPDA, getInvoiceIdPDA, getOfflineProgram, getPaymentInCurrencyPDA, getProgram, getPumpProgram, getPumpProgramWithFallback, getSharingConfigPDA, getTokenAgentPaymentsPDA, getWithdrawAuthorityPDA };
