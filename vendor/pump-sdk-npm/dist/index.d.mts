...
type PumpFees = {
        ...
        },
        {
            ...
            "accounts": [
                ...
                },
                {
                    ...
                    "address": "DRLYxueWz6iymdsaRCER6iv6v9zL7gFWANwDL2V5VUx1";
                },
                {
    ...
    "errors": [
        ...
        {
            "code": 6025;
            "name": "updateFeeSharesRequiresSingleDonationRecipient";
            "msg": "When using a DonationFeePda witness, update_fee_shares requires exactly one shareholder at 10_000 bps to that PDA";
        },
        {
            "code": 6026;
            "name": "invalidDonationFeePdaBinding";
            "msg": "DonationFeePda address or bump does not match derived PDA for this mint";
        },
        {
            "code": 6027;
            "name": "updateFeeSharesInvalidProgramWitness";
            "msg": "Fee-program-owned witness account must deserialize as DonationFeePda";
        },
        {
            "code": 6028;
            "name": "UpdateFeeSharesWrongRemainingAccountsLayout";
            "msg": "Remaining accounts must be current shareholders then new shareholders (same order as instruction data)";
        }
    ];
    "types": [
        {
    ...
    "constants": [
        ...
        {
            "name": "donationRelayId";
            "type": "pubkey";
            "value": "DRLYxueWz6iymdsaRCER6iv6v9zL7gFWANwDL2V5VUx1";
        },
        {
            "name": "epochTrackerV1";
            "type": "bytes";
